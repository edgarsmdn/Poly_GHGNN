...
def train_GHGNN_pss(df, split, i, dataset, rep, method_name, hyperparameters):
    ...
    if dataset == 'PDI':
        pretrained_model = '../../models/GHGNN_pretrained_small_systems/GHGNN_pretrained_small_systems_PDI_200.pth'
    else:
        pretrained_model = '../../models/GHGNN_pretrained_small_systems/GHGNN_pretrained_small_systems_MN_200.pth'
    ...
    for i in range(10):
        ...
        for dataset in ['MN', 'MW', 'PDI']:
            ...
            for rep in ['monomer', 'ru_w', 'ru_wo', 'oligomer_10']:
                ...
                print(rep)
                time.sleep(2)
                train_GHGNN_pss(df, split, i, dataset, rep, method_name, 
